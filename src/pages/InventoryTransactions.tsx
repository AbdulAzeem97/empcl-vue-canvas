...
import { sampleInventoryTransactions } from "@/data/sampleData";
...
const InventoryTransactions: React.FC = () => {
  ...
  const filteredTransactions = sampleInventoryTransactions.filter(transaction => {
    ...
    <div className="space-y-6">
      ...
      <div className="card-enterprise p-4">
        ...
        <div className="mt-4 text-sm text-muted-foreground">
          Showing {filteredTransactions.length} of {sampleInventoryTransactions.length} transactions
        </div>
      </div>
